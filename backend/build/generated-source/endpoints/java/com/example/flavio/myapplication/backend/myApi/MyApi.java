 ...
 * on 2016-03-13 at 10:33:49 UTC 
 * Modify at your own risk.
 */

package com.example.flavio.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getJavaJoke".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link GetJavaJoke#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public GetJavaJoke getJavaJoke() throws java.io.IOException {
    GetJavaJoke result = new GetJavaJoke();
    initialize(result);
    return result;
  }

  public class GetJavaJoke extends MyApiRequest<com.example.flavio.myapplication.backend.myApi.model.MyBean> {
     ...
     * parameters, call the {@link GetJavaJoke#execute()} method to invoke the remote operation. <p>
     * {@link
     * GetJavaJoke#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected GetJavaJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.flavio.myapplication.backend.myApi.model.MyBean.class);
    }
    ...
    @Override
    public GetJavaJoke setAlt(java.lang.String alt) {
      return (GetJavaJoke) super.setAlt(alt);
    }

    @Override
    public GetJavaJoke setFields(java.lang.String fields) {
      return (GetJavaJoke) super.setFields(fields);
    }

    @Override
    public GetJavaJoke setKey(java.lang.String key) {
      return (GetJavaJoke) super.setKey(key);
    }

    @Override
    public GetJavaJoke setOauthToken(java.lang.String oauthToken) {
      return (GetJavaJoke) super.setOauthToken(oauthToken);
    }

    @Override
    public GetJavaJoke setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetJavaJoke) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetJavaJoke setQuotaUser(java.lang.String quotaUser) {
      return (GetJavaJoke) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetJavaJoke setUserIp(java.lang.String userIp) {
      return (GetJavaJoke) super.setUserIp(userIp);
    }

    @Override
    public GetJavaJoke set(String parameterName, Object value) {
      return (GetJavaJoke) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.example.flavio.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.flavio.myapplication.backend.myApi.model.MyBean.class);
